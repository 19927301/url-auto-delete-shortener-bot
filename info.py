...
API_ID = int(environ.get('API_ID', '24170112'))
API_HASH = environ.get('API_HASH', '9931aa7072098af8725d2a3f180c2a07')
BOT_TOKEN = environ.get('BOT_TOKEN', "7335224853:AAFjwel391TA7zoop8oQb7nCLChbyRksMyw")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7322837992').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '0').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '7322837992').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://coloha5330:wYQquBRA4f5p8AK7@cluster0.irieu.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '2252343829'))
